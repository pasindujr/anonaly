...
@extends('layout')
@section('title', 'Account - '. $userData->name)
            ...
            <div class="md:flex no-wrap md:-mx-2 ">
                ...
                <div class="w-full md:w-3/12 md:mx-2">
                    ...
                    <div class="bg-white p-3 border-t-4 border-green-400">
                        ...
                        <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{{ $userData->name }}</h1>
                        ...
                        <ul
                            ...
                            <li class="flex items-center py-3">
                                ...
                                <span class="ml-auto">{{ $userData->created_at }}</span>
                            </li>
                        </ul>
                    </div>
                    <!-- End of profile card -->
                                ...
                                <ul class="list-inside space-y-2 mb-4">
                                    @foreach($userFeedbacks as $userFeedback)
                                        <li>
                                            ...
                                            <div>
                                                <a href="{{ url('account/feedback/delete/'. $userFeedback->id) }}" onclick="return confirm('Are you sure?');">
